...
assert(hml.includes('onclick="onOpenQuickAdd"'), 'The primary action must be a real HML click target.');
assert(hml.includes('<canvas if="{{ isHomeView }}" ref="progressCanvas"'), 'The home screen should use Lite Canvas for the edge progress ring.');
